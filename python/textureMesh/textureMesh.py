...
ms.parameterization__texturing_from_registered_rasters(texturesize=10240,colorcorrection=True,colorcorrectionfiltersize=1,usedistanceweight=True,useimgborderweight=True,usealphaweight=False,cleanisolatedtriangles=True,stretchingallowed=False,texturegutter=4)
print('saving')
